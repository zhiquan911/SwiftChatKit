...
class ChatForDBViewController: SwiftChatTableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.enableDBCacheMode(self.userId)
...
// MARK: - 聊天控制器代理方法
extension ChatForDBViewController {
...
// MARK: - learnCloud相关方法
extension ChatForDBViewController: AVIMClientDelegate {
...
extension ChatForDBViewController: SCShareMenuViewDelegate {
